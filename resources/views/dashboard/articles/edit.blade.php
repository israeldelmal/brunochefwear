	...
	<div class="forms">
		<div>
			...
			<form action="{{ url('/escritorio/articulos/actualizar/' . $article->id) }}" method="POST" enctype="multipart/form-data">
				...
				<div>
					<label for="slug">URL Actual: <strong>/{{  $article->slug }}</strong></label>
				...
				<div>
					...
					<textarea name="description" id="description" rows="3" placeholder="Descripción" maxlength="155" onKeyDown="contador()" onKeyUp="contador()">{{ $article->description }}</textarea>
